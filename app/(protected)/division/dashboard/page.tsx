...
export default function Page() {
  ...
  const fetchDashboardData = useCallback(async () => {
    ...
    try {
      ...
      // Users (excluding division_admin)
      ...
      // Enrollment by grade (current school year)
    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6 sm:p-8 shadow-xl">
        ...
        <div className="relative">
          <h1 className="app__title_text flex items-center gap-3 text-2xl font-bold text-white">

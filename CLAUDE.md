...
The legal set of `sms_users.type` lives in the `sms_users_type_check` constraint (001 → 011 → 031 → 067 → 095 → 102 → 135 → 139); labels and login rules live in `lib/constants/userTypes.ts`.
